            ...
            subscribe.next([
                {
                    ...
                    detail: `
<p>Après avoir découvert le C# durant mes études à INTECH, je suis allé faire mon alternance dans l'entreprise <a href="https://www.signature.one/" target="_blank">Signature One</a> qui utilise cette technologie comme base pour développer ses logiciels. J'ai donc pu continuer d'approfondir ma maîtrise du C# dans un contexte professionnel, avec notamment l'apprentissage de l'utilisation de ce denier avec des méthodes d'avantage professionnelles et industrielles.</p>
...
<p>C'est en entrant à INTECH que j'ai appris comment fonctionnent les pages Web, tout d'abord avec l'HTML, du CSS et le JavaScript. J'aimais me lancer des défis en créant des pages belles, bien structurées et dynamiques grâce à mes comptétances nouvellement acquises.</p>
...
<p>C'est en réalisant mes premiers projets informatique en équipe durant ma scolarité à INTECH que je me suis rendu compte de l'importance qu'à la communication dans le bon déroulement d'un projet. En effet il est important pour l'organisation, la transmission de connaîssances et autres brain storming, de bien communiquer avec son équipe.</p>
